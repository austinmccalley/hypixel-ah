...
def checkItems():
  try:
    cnx = connection.MySQLConnection(user="austin", password="password", database="hypixel_ah", port=6033 )
...
def populateItems(cnx: connection.MySQLConnection):
  ...
  add_item = ("INSERT INTO `items` (id, name, tier, material) VALUES(%s, %s, %s, %s)")
